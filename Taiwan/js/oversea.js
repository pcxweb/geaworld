...
function resulthtml(ele,data,num){
    ...
    for (var i = 0; i < data[ele].list.length; i++) {
        listLi +='<li class="col-md-6 col-xs-12"><a href="/Taiwan/oversealist.html?country='+num+'&title='+data[ele].list[i].zh+'"><img src="/geaGlobal/img/hk/'+data[ele].list[i].bgimg+'" alt="">'
