...
<div id="header-box">
			...
			<div class="nav-box">
		        ...
		        <div class="nav-right">
					...
					<div class="select-address">
						<div class="dropdown">
						    <button type="button" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">GEA Hong Kong
						    ...
						    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
						        ...
						        <li role="presentation">
						            <a role="menuitem" tabindex="-1" target="_blank" href="/mainland/">GEA Mainland</a>
						        </li>
						        <li role="presentation">
						            <a role="menuitem" tabindex="-1" href="https://www.geaperth.com.au/" target="_blank">GEA AUS</a>
						        </li>
						        <li role="presentation">
						            <a role="menuitem" tabindex="-1" href="/hk/">GEA Hong Kong</a>
						        </li>
						        <li role="presentation">
	...
	<div id="nav-menuId" class="nav-menu">
		<div class="nav-menu-list container">
			<ul>
				<li><a href="/hk/about.html">關於我們</a></li>
				<li><a href="/hk/index.html#school-event">海外院校</a></li>
				<li><a href="/hk/index.html#school-event">升學活動</a></li>
				<li><a href="/hk/index.html#footer">聯系我們</a></li>
			</ul>
		</div>
	</div>
</div>
    ...
    <div id="about-myCarousel" data-ride="carousel" class="carousel slide">
	    ...
	    <div class="carousel-inner">
	        <div class="item active">
	            <img src="/geaGlobal/img/hk/banner1.png" alt="First slide">
	        </div>
	        <div class="item">
	            <img src="/geaGlobal/img/hk/banner2.png" alt="Second slide">
	        </div>
	        <div class="item">
	            <img src="/geaGlobal/img/hk/banner3.png" alt="Second slide">
	        </div>
	        <div class="item">
	            <img src="/geaGlobal/img/hk/banner4.png" alt="Second slide">
	        </div>
	    </div>
		...
		<div class="row">
			<div class="col-md-6 col-xs-12">
				<div class="login-cpp loginbox">
					...
					<div class="click-register">沒有賬號？點擊<a href="/hk/register.html">註冊</a>。</div>
				</div>
			</div>
			<div class="col-md-6 col-xs-12">
					...
					<div class="swiper-container" id="school-swiper" style="height: 100%">
					    <div class="swiper-wrapper">
					      	<div class="swiper-slide">
					      		<a href="/hk/oversea.html?country=uk"><img src="/geaGlobal/img/hk/slice1.png" alt=""><span> 英國升學 Study in UK</span></a>
					      	</div>
					      	<div class="swiper-slide">
					      		<a href="/hk/oversea.html?country=us"><img src="/geaGlobal/img/hk/slice2.jpg" alt=""><span> 美國升學 Study in US</span></a>
					      	</div>
							<div class="swiper-slide">
								<a href="/hk/oversea.html?country=au"><img src="/geaGlobal/img/hk/slice3.jpg" alt=""><span> 澳洲升學 Study in Australia</span></a>
							</div>
							<div class="swiper-slide">
								<a href="/hk/oversea.html?country=ca"><img src="/geaGlobal/img/hk/slice4.jpg" alt=""><span> 加拿大升學 Study in Canada</span></a>
							</div>
							<div class="swiper-slide">
								<a href="/hk/oversea.html?country=ze"><img src="/geaGlobal/img/hk/slice5.jpg" alt=""><span> 紐西蘭升學 Study in New Zealand</span></a>
							</div>
							<div class="swiper-slide">
								<a href="/hk/oversea.html?country=ot"><img src="/geaGlobal/img/hk/slice6.jpg" alt=""><span> 其他國家 Others</span></a>
							</div>
					    </div>
					</div>
				</div>
...
<div id="partner" class="conbox">
	...
	<div class="partner-box">
		<div class="swiper-container" id="partner-swiper" style="height: 100%">
		    <div class="swiper-wrapper">
		      	<div class="swiper-slide">
		      		<a href="http://www.wisdomglobal.hk/" target="_blank"><img src="/geaGlobal/img/hk/hklogo.png" alt=""></a>
		      	</div>
		    </div>
		    <div class="swiper-button-prev partner-prev"></div><!--左箭头-->
    		<div class="swiper-button-next partner-next"></div><!--右箭头-->
		</div>
	</div>
</div>
<!-- 底部 -->
		...
		<div class="container">
			<div class="col-xs-12">
				...
				<div class="foot-icon clearfix">
					<ul class="clearfix">
						<li><a href="https://www.facebook.com/Globaleducationalliance/" target="_blank"><span class="fa fa-facebook"></span></a></li>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-6 foot-menu">
					...
					<div class="foot-address">
						<span class="fa fa-map-marker"></span>
						<span>香港新界沙田安群街3號京瑞廣場1期15樓B室</span>  
					</div>
					<div class="foot-address">
...
$(function(){
	 // 香港
    $.ajax({
        url:"/geaGlobal/js/hkevent.json",
        dataType:"json",
        type:"get",
        success:function(data){
            // console.log(data.schoolOne.length)
            $(".schoolOne").append(resultList("schoolOne",data));
            var schoolboxH = $(".schoolevent").height();
    		console.log(schoolboxH)
